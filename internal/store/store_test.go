...
func TestSQLiteDSNDoesNotRequestJournalModeOnOpen(t *testing.T) {
	...
	for _, pragma := range pragmas {
		if strings.HasPrefix(strings.ToLower(pragma), "journal_mode(") {
			t.Fatalf("open DSN changes journal mode: %q", pragmas)
		}
	}
}
